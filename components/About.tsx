...
export const About: React.FC = () => {
    return (
        <div className="w-full min-h-screen bg-white text-black p-8 mt-12 md:mt-0 mx-auto">
            ...
            {/* Introduction */}
            <section>
                <h2 className="text-gray-400 mb-8">Introduction</h2>
            ...
            <div className="space-y-32 mt-32"> {/* Increased spacing for better separation */}
                ...
                <div className="grid grid-cols-1 dt:grid-cols-2 gap-12 border-t border-gray-100 pt-16 -mx-8 px-8">
                    {/* Experience */}
                    <section>
                        <h2 className="text-gray-400 mb-8">Experience</h2>
                    ...
                    {/* Education */}
                    <section>
                        <h2 className="text-gray-400 mb-8">Education</h2>
                        <div className="space-y-12">
                            <div className="group">
                                <div className="flex flex-col md:flex-row md:items-baseline justify-between">
                ...
                {/* Exhibitions & Invited Talk */}
                <div className="grid grid-cols-1 dt:grid-cols-2 gap-12 border-t border-gray-100 pt-16 -mx-8 px-8">
                    {/* Exhibitions */}
                    <section>
                        <h2 className="text-gray-400 mb-8">Exhibitions</h2>
                        <div className="space-y-4">
                            <div className="group">
                                <div className="flex items-baseline justify-between">
                                    <h3 className="text group-hover:text-gray-800 transition-colors">UAL : Creative Computing Exhibition</h3>
                                    <span className="subtext text-gray-400">May 2026</span>
                                </div>
                                <p className="subtext text-gray-500">Copeland gallery | London, UK</p>
                                <p className="subtext text-gray-500">New Media Art : Performance</p>
                            </div>
                            <div className="group">
                                <div className="flex items-baseline justify-between">
                                    <h3 className="text group-hover:text-gray-800 transition-colors">AI Art Magazine Exhibition</h3>
                                    <span className="subtext text-gray-400">Apr 2026</span>
                                </div>
                                <p className="subtext text-gray-500">OFFF, Load gallery | Barcelona, Spain</p>
                                <p className="subtext text-gray-500">An New Media Art : AI-powered generative language model</p>
                            </div>
                            <div className="group">
                                <div className="flex items-baseline justify-between">
                                    <h3 className="text group-hover:text-gray-800 transition-colors">Korea Young Designer Exhibition</h3>
                                    <span className="subtext text-gray-400">May 2022</span>
                                </div>
                                <p className="subtext text-gray-500">Sookmyung Women's University | Seoul, Korea</p>
                                <p className="subtext text-gray-500">XR Schooling Universal Design Project Utilising AI</p>
                            </div>
                            <div className="group">
                                <div className="flex items-baseline justify-between">
                                    <h3 className="text group-hover:text-gray-800 transition-colors">Graduation Exhibition</h3>
                                    <span className="subtext text-gray-400">Dec 2022</span>
                                </div>
                                <p className="subtext text-gray-500">SADI | Seoul, Korea</p>
                                <p className="subtext text-gray-500">XR Expand User-Customised Theme Park Experiences<br />Seniors Online Community and Social Rehabilitation Services<br />Graduation Preparation Committee</p>
                            </div>
                            <div className="group">
                                <div className="flex items-baseline justify-between">
                                    <h3 className="text group-hover:text-gray-800 transition-colors">Samsung Design Membership Project</h3>
                                    <span className="subtext text-gray-400">2020 – 2022</span>
                                </div>
                                <p className="subtext text-gray-500">Samsung Seoul R&D Center | Seoul, Korea</p>
                                <p className="subtext text-gray-500">AI Playlist Project Utilising AR and IoT (2021)<br />Products for Home Office Environments (2020)</p>
                            </div>
                            <div className="group">
                                <div className="flex items-baseline justify-between">
                                    <h3 className="text group-hover:text-gray-800 transition-colors">Busan Design Week</h3>
                                    <span className="subtext text-gray-400">Jul 2021</span>
                                </div>
                                <p className="subtext text-gray-500">Samsung Exhibition Convention Center | Busan, Korea</p>
                                <p className="subtext text-gray-500">AI Smartwatch for the Hearing Impaired and People with Communication Difficulties</p>
                            </div>
                            <div className="group">
                                <div className="flex items-baseline justify-between">
                                    <h3 className="text group-hover:text-gray-800 transition-colors">Hanul Exhibition</h3>
                                    <span className="subtext text-gray-400">Jul 2021</span>
                                </div>
                                <p className="subtext text-gray-500">Korea National Museum | Seoul, Korea</p>
                                <p className="subtext text-gray-500">Infographic Poster on the History of the Human Rights Movement in Korea</p>
                            </div>
                            <div className="group">
                                <div className="flex items-baseline justify-between">
                                    <h3 className="text group-hover:text-gray-800 transition-colors">Weltformat Korea Festival</h3>
                                    <span className="subtext text-gray-400">Jul 2021</span>
                                </div>
                                <p className="subtext text-gray-500">KF Gallery | Seoul, Korea</p>
                                <p className="subtext text-gray-500">Typographic Media Art Project : Experimentation with New Types and Visualisation of Historical Information</p>
                            </div>
                        </div>
                    </section>

                    {/* Invited Talk & Publication */}
                    <section>
                        <h2 className="text-gray-400 mb-8">Invited Talk & Publication</h2>
                        <div className="space-y-4">
                            <div className="group">
                                <div className="flex items-baseline justify-between">
                                    <h3 className="text group-hover:text-gray-800 transition-colors">AI Art Talk</h3>
                                    <span className="subtext text-gray-400">2026</span>
                                </div>
                                <p className="subtext text-gray-500">Load gallery | Barcelona, Spain</p>
                            </div>
                            <div className="group">
                                <div className="flex items-baseline justify-between">
                                    <h3 className="text group-hover:text-gray-800 transition-colors">AI Art Magazine</h3>
                                    <span className="subtext text-gray-400">2026</span>
                                </div>
                                <p className="subtext text-gray-500">Printed Magazine | Berlin, Germany</p>
                            </div>
                            <div className="group">
                                <div className="flex items-baseline justify-between">
                                    <h3 className="text group-hover:text-gray-800 transition-colors">New Media Art Conversation</h3>
                                    <span className="subtext text-gray-400">2026</span>
                                </div>
                                <p className="subtext text-gray-500">Polardots Studio | Hamburg, Germany</p>
                            </div>
                            <div className="group">
                                <div className="flex items-baseline justify-between">
                                    <h3 className="text group-hover:text-gray-800 transition-colors">Seminar Invited Speaker</h3>
                                    <span className="subtext text-gray-400">2026</span>
                                </div>
                                <p className="subtext text-gray-500">NordSync | Oslo, Norway</p>
                            </div>
                            <div className="group">
                                <div className="flex items-baseline justify-between">
                                    <h3 className="text group-hover:text-gray-800 transition-colors">Graduation Invited Speaker</h3>
                                    <span className="subtext text-gray-400">2024</span>
                                </div>
                                <p className="subtext text-gray-500">Printed Magazine | Rome, Italy</p>
                            </div>
                            <div className="group">
                                <div className="flex items-baseline justify-between">
                                    <h3 className="text group-hover:text-gray-800 transition-colors">Graduation Invited Speaker</h3>
                                ...
                                <p className="subtext text-gray-500">Seoul National University | Korea</p>
                            </div>
                            <div className="group">
                                <div className="flex items-baseline justify-between">
                                    <h3 className="text group-hover:text-gray-800 transition-colors">Graduation Invited Speaker</h3>
                                ...
                                <p className="subtext text-gray-500">Hongik University | Seoul, Korea</p>
                            </div>
                            <div className="group">
                                <div className="flex items-baseline justify-between">
                                    <h3 className="text group-hover:text-gray-800 transition-colors">UX Workshop Tutor</h3>
                                    <span className="subtext text-gray-400">2022–Present</span>
                                </div>
                                <p className="subtext text-gray-500">Samsung | Seoul, Korea</p>
                            </div>
                            <div className="group">
                                <div className="flex items-baseline justify-between">
                                    <h3 className="text group-hover:text-gray-800 transition-colors">Busan Design Week</h3>
                                    <span className="subtext text-gray-400">2021</span>
                                </div>
                                <p className="subtext text-gray-500">BEXCO | Busan, Korea</p>
                            </div>
                        </div>
                    </section>
                </div>
                ...
                <div className="grid grid-cols-1 dt:grid-cols-2 gap-12 border-t border-gray-100 pt-16 -mx-8 px-8">
                    {/* Patents */}
                    <section>
                        <h2 className="text-gray-400 mb-8">Patents</h2>
                    ...
                    {/* Awards */}
                    <section>
                        <h2 className="text-gray-400 mb-8">Awards</h2>
                ...
                {/* Tools Grid & Skills */}
                <section className="border-t border-gray-100 pt-16 -mx-8 px-8">
                    <h2 className="text-gray-400 mb-8">Skills & Tools</h2>
