            ...
            <section className="space-y-12">
                ...
                <div>
                    <div className="flex flex-col items-start gap-4">
                        ...
                        <a target="_blank" href="https://drive.google.com/file/d/1UTGchW8Tl3nvyc-GNFN4ONbcDpekQ9zw/view?usp=sharing" className="subtitle hover:text-gray-600 transition-colors">
                            View CV
                        </a>
                    </div>
                </div>
