...
export const UniversalWearableProduct: React.FC = () => {
 ...
 <div className="w-full min-h-screen bg-white text-black p-8 mt-12 md:mt-0 mx-auto">
  ...
  <h1 className="title mb-6">
   Universal Wearable Product
  </h1>
  <p className="subtitle text-gray-600 max-w-2xl">
   Wearable Computing Project, 2023
  </p>
  </header>
  ...
  <img src="/thumbnail/6.png" alt="Efficient Daily Experiences" className="w-full h-full object-cover" />
  </div>
  ...
  <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
   ...
   <ul className="space-y-4 text-gray-600">
    <li>
    <span className="block text-xs text-gray-400 mb-1">Role</span>
    UX UI Designer
    </li>
    <li>
    ...
    <li>
    <span className="block text-xs text-gray-400 mb-1">Tools</span>
    Figma, Protopie
    </li>
   </ul>
   </div>
